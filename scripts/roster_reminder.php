...
$css=ifdef($ini['FORMATTING'], '');
$pre_message=ifdef($ini['PRE_MESSAGE'], "This week's roster: <br>");
$post_message=ifdef($ini['POST_MESSAGE'], "Thanks for serving. <br> Please don't reply to this email.");
...
$longstring = "<html><head><style>".$css."</style></head>";
$longstring.=$pre_message."<br>";
$longstring.="<b>Roster: ";
$longstring.=$roster_name."</b>";
$longstring.=$table_contents;
$longstring.="<br>".$post_message;
$longstring.="<br><br><i>Roster reminder generated by the ".SYSTEM_NAME." Jethro system.</i><br>"; 
